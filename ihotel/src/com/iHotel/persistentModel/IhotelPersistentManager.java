...
public class IhotelPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "Ihotel";
	...
	private IhotelPersistentManager() throws PersistentException {
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new IhotelPersistentManager();
		}
