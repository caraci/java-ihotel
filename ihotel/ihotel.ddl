...
CREATE TABLE Camera (ID int(11) NOT NULL AUTO_INCREMENT, AlbergoID int(11), PRIMARY KEY (ID)) ENGINE=InnoDB CHARACTER SET UTF8;
CREATE TABLE CatalogoCamere (ID int(11) NOT NULL AUTO_INCREMENT, PRIMARY KEY (ID)) ENGINE=InnoDB CHARACTER SET UTF8;
CREATE TABLE DescrizioneCamera (ID int(11) NOT NULL AUTO_INCREMENT, CatalogoCamereID int(11), PRIMARY KEY (ID)) ENGINE=InnoDB CHARACTER SET UTF8;
